...
export function CollapsiblePreview() {
  ...
  return (
    <ComponentPage title="Collapsible" description="用于展开或收起内容" docs={<Docs components={mdxComponents} />}>
      <div className="w-full max-w-md space-y-3">
        <Collapsible open={open} onOpenChange={setOpen}>
          ...
          <CollapsibleContent className="text-muted-foreground text-sm">
            This panel contains additional information and metadata for the project.
          </CollapsibleContent>
        </Collapsible>
      </div>
    </ComponentPage>
